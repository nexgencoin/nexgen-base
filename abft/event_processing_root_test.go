...
func TestNexgenBFTClassicRoots(t *testing.T) {
...
func TestNexgenBFTRandomRoots(t *testing.T) {
	// generated by codegen4NexgenBFTRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeNexgenBFT(nodes, nil)
...
/*
// codegen4NexgenBFTRandomRoot is for test data generation.
func codegen4NexgenBFTRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeNexgenBFT(nodes)
	// process events
	config := inter.Events{}
